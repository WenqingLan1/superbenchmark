...
class TestNvbenchKernelLaunchBenchmark(BenchmarkTestCase, unittest.TestCase):
    ...
    def test_nvbench_kernel_launch_result_parsing_real_output(self, results):
        ...
        assert benchmark.result['gpu_0_samples'][0] == 160430
        assert benchmark.result['gpu_0_cpu_time'][0] == 22.181
        assert benchmark.result['gpu_0_cpu_noise'][0] == 30.44
        assert benchmark.result['gpu_0_gpu_time'][0] == 5.878
        assert benchmark.result['gpu_0_gpu_noise'][0] == 14.42
        assert benchmark.result['gpu_0_batch_samples'][0] == 497001
        assert benchmark.result['gpu_0_batch_gpu_time'][0] == 4.024
